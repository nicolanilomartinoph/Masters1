...
<div class="container-fluid darkbg">
    <div class="container bg-dark">
            ...
            <div class="row">
                <form class="col-12 mb-5" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="col-md-12 my-2">
                        <input id="username" type="text" class="registerInputbg form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" placeholder="username" autofocus>
                        @error('username')
        ...
        <div class="row text-center my-5">
            <div class="col-12">
                <h4>
                    <pre class="text-light bg-transparent border-0">CAREERS  <span class="footerSeparator">|</span>  ABOUT  <span class="footerSeparator">|</span>  SUPPORT  <span class="footerSeparator">|</span>  CONTACT US  <span class="footerSeparator">|</span>  PRESS  <span class="footerSeparator">|</span>  API</pre>
                </h4>
            </div>
        </div>
